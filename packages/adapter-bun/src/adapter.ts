...
import { buildDeploymentManifest, collectOutputPathnames } from './manifest'
import { SCHEMA_SQL } from './runtime/sqlite-cache'
import { stageStaticAssets, writeJsonFile } from './staging'
import type {
    ...
    return {
        ...
        modifyConfig(config) {
            ...
            const existingServerActions =
                existingServerActionsRaw &&
                typeof existingServerActionsRaw === 'object'
