...
import { ActionMenu, ActionMenuGroup } from "@packages/shared/components";
import { VisualizationTitle } from "@packages/shared/components";
import { CaptionPopover } from "@packages/shared/components";
import { MapTableComponent } from "@packages/shared/components";
...
export function MapVisComponent({
  ...
  }, [mapConfig.name, showTable, printPlugin]);
