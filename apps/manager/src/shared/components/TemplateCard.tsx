                ...
                <Card className="inline-flex flex-col justify-center items-center box-border rounded">
                    <div className="flex flex-col items-center justify-center h-[calc(100%-16px)] p-4 gap-8">
                        <div className="flex items-center justify-center ">
                            <div
                                className="w-[50px] h-[50px] [&_svg]:w-[50px] [&_svg]:h-[50px]"
                                style={{ color: '#2C6693' }}
                            >
                                {template.icon}
                            </div>
                        ...
                        <div className="flex flex-col items-center w-full gap-2 text-center">
                            <h4 className="m-0 text-gray-800 font-bold text-[16px] inline">
                                {' '}
                                {i18n.t(template.title)}
                            </h4>
                            <span className="text-gray-600 font-normal text-sm max-w-xs break-words">
