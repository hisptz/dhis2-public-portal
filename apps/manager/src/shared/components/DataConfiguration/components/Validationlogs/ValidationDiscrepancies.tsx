...
export function ValidationDiscrepancies({ discrepancies, isLoading, error }: ValidationDiscrepanciesProps) {
    ...
    return (
        <div>
            ...
            {(() => {
                const dataElementDataMap = new Map<string, Map<string, { source: unknown; destination: unknown; hasDiscrepancy: boolean }>>();
