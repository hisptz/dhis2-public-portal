...
export function SortItemsForm({ items: initialItems, onClose, onSubmit, hide }: SortItemsProps) {
        ...
        <Modal position="middle" hide={hide} onClose={handleCloseClick}>
                    ...
                    <Droppable droppableId="staticItemsSortableList">
                        {(provided) => (
                            <div
                                ...
                                style={{
                                    minHeight: currentItems.length > 0 ? "auto" : "100px",
                                }}
                            >
                                        ...
                                        {(providedDraggable, snapshot) => (
                                            <div
                                                ...
                                                style={{
                                                    ...
                                                    padding: "10px 12px",
                                                    backgroundColor: snapshot.isDragging ? "#e9ecef" : "#ffffff",
                                                    display: "flex",
                                                    alignItems: "center",
                                                    borderRadius: "4px",
                                                    userSelect: "none",
            ...
            <ModalActions>
                <ButtonStrip>
                    ...
                    >
                        {isSubmitting ? i18n.t("Saving...") : i18n.t("Save order")}
                    </Button>
                </ButtonStrip>
            </ModalActions>
        </Modal>
