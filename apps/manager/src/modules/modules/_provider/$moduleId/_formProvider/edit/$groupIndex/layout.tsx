...
function RouteComponent() {
	...
	>({
		name: `config.groups.${groupIndex}.items`,
	...
	const onAddVisualization = useCallback(
		(visualization: VisualizationItem) => {
			...
			append(displayItem);
			const layouts = getValues(`config.groups.${groupIndex}.layouts`) as FlexibleLayoutConfig;
			if (layouts) {
				...
				setValue(`config.groups.${groupIndex}.layouts`, updatedLayouts);
			} else {
				setValue(`config.groups.${groupIndex}.layouts`, {
		...
		[append, getValues, groupIndex, setValue],
	);
	...
	const handleDelete = useCallback(
		...
		[fields, remove, getValues, groupIndex, setValue]
	);
