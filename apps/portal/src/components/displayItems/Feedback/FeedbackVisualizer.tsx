...
import { Button, TextInput, Textarea, Alert, Group, useMantineTheme } from "@mantine/core";
...
export default function FeedbackVisualizer({ item }: { item: FeedbackItem }) {
    ...
    const onFormSubmit = useCallback(async (data: FeedbackConfig) => {
        try {
            ...
            const errorMessage = e instanceof Error ? e.message : "Error sending feedback. Try again later.";
            notifications.show({
                title: i18n.t("Error"),
                ...
                <div className="flex flex-col gap-4 w-full">
                    <Alert
                        ...
                        styles={{
                            ...
                            title: { color: theme.colors.gray[9], fontWeight: 700 },
                    ...
                    <TextInput
                        ...
                        styles={{
                            input: {
                                ...
                                "&:focus": { borderColor: theme.colors[theme.primaryColor][5] },
                            },
